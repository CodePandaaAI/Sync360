...
| `hero-demo.mp4` | Main README video showing the current Android discovery, approval, text, and file-transfer experience | 1200x675 or 1280x720; H.264 preferred |
...
| `architecture-preview.png` | Visual architecture preview | 1600x900 |
| `desktop-home.png` | Desktop screenshot later | 1600x1000 or 1920x1080 |
| `roadmap-preview.png` | Optional roadmap/social preview | 1600x900 |

## Recommended GitHub style

- Keep images readable in both light and dark GitHub themes.
- Prefer concise H.264 MP4 videos for longer demos and short GIFs only when animation playback is more useful than video controls.
